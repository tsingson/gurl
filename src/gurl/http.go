...
var defaultSetting = httpclient.GurlHttpSettings{
	ShowDebug:        true,
...
func getHTTP(method string, url string, args []string) (r *httpclient.GurlHttpRequest) {
	r = httpclient.NewGurlRequest(url, method)
...
func formatResponseBody(res *http.Response, httpreq *httpclient.GurlHttpRequest, pretty bool) string {
